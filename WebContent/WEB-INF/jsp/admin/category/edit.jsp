        ...
        <div class="col-sm-12">
          ...
          <div class="table-responsive">
		    <div class="card col-sm-6" style="margin: auto;">
                  <div class="card-body">
                    <form id="edit-category" action="${pageContext.request.contextPath }/admin/category-edit" method="post" >
                      ...
                      <div class="form-group">
                      	<input type="hidden" id="cat_id" name="cat_id" value="${category.cat_id }" class="form-control">
                      </div>
