        ...
        <div class="col-sm-12">
          ...
          <div class="table-responsive">
		    <div class="card col-sm-6" style="margin: auto;">
                  <div class="card-body">
                    <form id="add-user" action="${pageContext.request.contextPath }/admin/user-add" method="post" >
                      ...
                      <div class="form-group">
                     	<select class="form-control" name="id_role">
                     		<c:forEach items="${listRole }" var="role">
                     			<option <c:if test="${user.name_role == role.id }">selected='selected'</c:if> value="${role.id }">${role.name }</option>
                     		</c:forEach>
                     	</select>
                      </div>
