    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Edit Comic </div>
        <div class="card-body">
        <div class="col-sm-12">
      		<c:if test="${msg != null }">
          ...
          <div class="table-responsive">
		    <div class="card col-sm-12" style="margin: auto;">
                  <div class="card-body">
                    <form id="edit-comic" action="${pageContext.request.contextPath }/admin/comic-edit" method="post" enctype="multipart/form-data">
                    <div class="row">
