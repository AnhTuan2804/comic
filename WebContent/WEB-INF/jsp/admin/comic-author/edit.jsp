    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Edit Comic Author </div>
        <div class="card-body">
        <div class="col-sm-12">
      		<c:if test="${msg != null }">
          ...
          <div class="table-responsive">
		    <div class="card col-sm-6" style="margin: auto;">
                  <div class="card-body">
                    <form id="add-category" action="${pageContext.request.contextPath }/admin/comic-author-edit" method="post" >
                      ...
                      <div>
                     	<input type="hidden" value="${comicAuthor.id }" name="id" class="form-control" />
                      </div>
